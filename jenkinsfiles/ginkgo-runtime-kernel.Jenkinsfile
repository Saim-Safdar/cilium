...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:1a75a6f8c0daef3add7a0189d52af637ad64b9f6@sha256:802b1dd465eae870ff266a96b3bd45e0e513dd9c7af8d0eaae6a5a61cf2d7b87"; fi'
            )}"""
    }
